...
// m3u8DownloadServer = JSON.parse(localStorage['m3u8DownloadServer']);
// // for(var i = 0; i < m3u8DownloadServer.length; i++){
// //     $('#ExtTd').append(GethtmlExt(Ext[i].ext,Ext[i].size));
// // }
// $('#server_ip').val=m3u8DownloadServer.IP;
// $('#server_name').val=m3u8DownloadServer.FileName;
// $('#server_port').val=m3u8DownloadServer.Port;
...
$('#server_ip').val(localStorage['m3u8DownloadServer_ip']);
$('#server_name').val(localStorage['m3u8DownloadServer_file']);
$('#server_port').val(localStorage['m3u8DownloadServer_port']);
...
$('#SaveExt').bind("click", function(){
    ...
    localStorage['m3u8DownloadServer_ip']=$('#server_ip').val();
    localStorage['m3u8DownloadServer_file']=$('#server_name').val();
    localStorage['m3u8DownloadServer_port']=$('#server_port').val();
});
...
$('#ResetExt').bind("click", function(){
    ...
    delete localStorage['m3u8DownloadServer_ip'];
    delete localStorage['m3u8DownloadServer_file'];
    delete localStorage['m3u8DownloadServer_port'];
    location.reload();
});